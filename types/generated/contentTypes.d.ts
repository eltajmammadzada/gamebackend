...
export interface ApiCategoryCardCategoryCard extends Schema.CollectionType {
...
export interface ApiHomeSection3HomeSection3 extends Schema.CollectionType {
  collectionName: 'home_section3s';
  info: {
    singularName: 'home-section3';
    pluralName: 'home-section3s';
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::home-section3.home-section3',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
...
export interface ApiNewsCardNewsCard extends Schema.CollectionType {
...
export interface ApiProHeaderProHeader extends Schema.CollectionType {
  collectionName: 'pro_headers';
  info: {
    singularName: 'pro-header';
    pluralName: 'pro-headers';
    displayName: 'proHeader';
  };
  options: {
    draftAndPublish: true;
  };
...
export interface ApiProssPross extends Schema.CollectionType {
...
export interface ApiTendingTending extends Schema.CollectionType {
  collectionName: 'tendings';
  info: {
    singularName: 'tending';
    pluralName: 'tendings';
    displayName: 'hometending';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    size: Attribute.Integer &
      ...
      Attribute.SetMinMax<
        ...
        number
      >;
    sekil: Attribute.Media<'images' | 'files' | 'videos' | 'audios'>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::home-section3.home-section3': ApiHomeSection3HomeSection3;
      'api::navbar.navbar': ApiNavbarNavbar;
      'api::news-card.news-card': ApiNewsCardNewsCard;
      'api::pro-header.pro-header': ApiProHeaderProHeader;
      'api::pross.pross': ApiProssPross;
      'api::tending.tending': ApiTendingTending;
    }
  }
}
